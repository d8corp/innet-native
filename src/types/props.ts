...
import {
  ...
  type ActionBarNSProps,
  type ActionItemNSProps,
  type ActivityIndicatorNSProps,
  type ButtonNSProps,
  type ContainerViewNSProps,
  type ContentViewNSProps,
  type DatePickerNSProps,
  type DockLayoutNSProps,
  type EditableTextBaseNSProps,
  type FlexboxLayoutNSProps,
  type FormattedStringNSProps,
  type FrameNSProps,
  type GridLayoutNSProps,
  type HtmlViewNSProps,
  type ImageNSProps,
  type LabelNSProps,
  type LayoutBaseNSProps,
  type ListPickerNSProps,
  type ListViewNSProps,
  type NavigationButtonNSProps,
  type PageNSProps,
  type PlaceholderNSProps,
  type ProgressNSProps,
  type ProxyViewContainerNSProps,
  type RootLayoutNSProps,
  type ScrollViewNSProps,
  type SearchBarNSProps,
  type SegmentedBarItemNSProps,
  type SegmentedBarNSProps,
  type SliderNSProps,
  type SpanNSProps, type SplitViewNSProps,
  type StackLayoutNSProps,
  type SwitchNSProps,
  type TabViewItemNSProps,
  type TabViewNSProps,
  type TextBaseNSProps,
  type TextFieldNSProps,
  type TextViewNSProps,
  type TimePickerNSProps,
...
export type SplitViewProps<T extends SplitView = SplitView, P extends SplitViewNSProps<T> = SplitViewNSProps<T>> = LayoutBaseProps<T, P>
