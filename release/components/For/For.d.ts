...
export declare function For<T extends StateProp<Iterable<any>>, V extends ForKey<GetType<T>, any>>({ key, of: ofPropRaw, children, }: ForProps<T, V>): JSX.Element[] | typeof EMPTY;
export {};
